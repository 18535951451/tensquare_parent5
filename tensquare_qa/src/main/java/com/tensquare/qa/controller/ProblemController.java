...
public class ProblemController {
	...
	public Result newlist(@PathVariable("labelid") String labelid,@PathVariable("age") int page,@PathVariable("size") int size){
	...
	public Result hotlist(@PathVariable("labelid") String labelid,@PathVariable("age") int page,@PathVariable("size") int size){
	...
	public Result waitlist(@PathVariable("labelid") String labelid,@PathVariable("age") int page,@PathVariable("size") int size){
